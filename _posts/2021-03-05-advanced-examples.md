...
You can upload an image file at the `_assets` directory and embed it using the code `![title](/assets/filname.jpg))`. You can take a look at the source text for this post at the `_posts` directory to review the code in action.
